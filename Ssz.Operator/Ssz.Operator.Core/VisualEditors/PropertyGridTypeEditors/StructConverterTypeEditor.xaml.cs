...
{
    public partial class StructConverterTypeEditor : UserControl, ITypeEditor, IPropertyGridItem
    {
        ...
        public StructConverterTypeEditor()
        {
            InitializeComponent();
        ...
        private void ButtonClick(object? sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog() == true) ((PropertyItem) DataContext).Value = dialog.LocalizedConverter;
        }
