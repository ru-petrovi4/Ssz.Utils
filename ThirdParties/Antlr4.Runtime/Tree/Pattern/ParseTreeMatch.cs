...
namespace Antlr4.Runtime.Tree.Pattern
{
    ...
    public class ParseTreeMatch
    {
        ...
        /// <summary>Gets a value indicating whether the match designTask succeeded.</summary>
        /// <remarks>Gets a value indicating whether the match designTask succeeded.</remarks>
        /// <returns>
        ///
        /// <see langword="true"/>
        /// if the match designTask succeeded; otherwise,
        /// <see langword="false"/>
        /// .
        /// </returns>
