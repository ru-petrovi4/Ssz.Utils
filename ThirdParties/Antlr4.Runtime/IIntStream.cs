...
namespace Antlr4.Runtime
{
    ...
    public interface IIntStream
    {
        ...
        /// </remarks>
        /// <exception cref="System.InvalidDesignTaskException">
        ...
        /// as part of an designTask to safely work within a
        ...
        /// <paramref name="index"/>
        /// . If the
        /// specified index lies past the end of the stream, the designTask behaves as
        /// though
        /// <paramref name="index"/>
        ...
        /// designTask to target a non-ignored symbol.</li>
        /// <li>
        /// <c>LA(1)</c>
        /// returns
        /// <see cref="IntStreamConstants.EOF"/>
        /// </li>
        /// </ul>
        /// This designTask is guaranteed to not throw an exception if
        /// <paramref name="index"/>
