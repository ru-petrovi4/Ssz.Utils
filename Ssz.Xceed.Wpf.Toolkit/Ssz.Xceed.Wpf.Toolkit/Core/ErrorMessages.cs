...
namespace Ssz.Xceed.Wpf.Toolkit.Core
{
    internal static class ErrorMessages
    {
        ...
        {
            _resourceManager =
                new ResourceManager("Ssz.Xceed.Wpf.Toolkit.Core.ErrorMessages", typeof(ErrorMessages).Assembly);
        }
        ...
        public const string AlreadyInColumnCollection =
            "Value already belongs to another 'ColumnDefinitionCollection'.";
