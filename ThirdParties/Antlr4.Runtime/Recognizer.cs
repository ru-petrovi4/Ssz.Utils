...
namespace Antlr4.Runtime
{
        ...
        where ATNInterpreter : ATNSimulator
    {
        ...
        /// </remarks>
        [ObsoleteAttribute(@"This method is not called by the ANTLR 4 Play. Specific implementations of IAntlrErrorStrategy may provide a similar feature when necessary. For example, see DefaultErrorStrategy.GetTokenErrorDisplay(IToken).")]
