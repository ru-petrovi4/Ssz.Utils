...
using System.Text;
using Ssz.WindowsAPICodePack.Shell.PropertySystem;
using Ssz.WindowsAPICodePack.Taskbar;
using MS.WindowsAPICodePack.Internal;

namespace Ssz.WindowsAPICodePack.Shell
{
...
#pragma warning disable 108
    ...
    interface IThumbnailCache
    {
        ...
        [In] Ssz.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailOptions flags,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out Ssz.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags,
        [Out] Ssz.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailId pThumbnailID);

        void GetThumbnailByID([In] Ssz.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailId thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out Ssz.WindowsAPICodePack.Shell.ShellNativeMethods.ThumbnailCacheOptions pOutFlags);
    }
