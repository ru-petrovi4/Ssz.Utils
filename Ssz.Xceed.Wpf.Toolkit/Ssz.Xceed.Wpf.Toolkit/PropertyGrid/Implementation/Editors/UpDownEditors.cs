...
namespace Ssz.Xceed.Wpf.Toolkit.PropertyGrid.Editors
{
    ...
    public class PropertyGridEditorByteUpDown : ByteUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorByteUpDown),
    ...
    public class PropertyGridEditorDecimalUpDown : DecimalUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorDecimalUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorDecimalUpDown)));
        }
    }
    ...
    public class PropertyGridEditorDoubleUpDown : DoubleUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorDoubleUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorDoubleUpDown)));
        }
    }
    ...
    public class PropertyGridEditorIntegerUpDown : IntegerUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorIntegerUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorIntegerUpDown)));
        }
    }
    ...
    public class PropertyGridEditorLongUpDown : LongUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorLongUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorLongUpDown)));
        }
    }
    ...
    public class PropertyGridEditorShortUpDown : ShortUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorShortUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorShortUpDown)));
        }
    }
    ...
    public class PropertyGridEditorSingleUpDown : SingleUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorSingleUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorSingleUpDown)));
        }
    }
    ...
    internal class PropertyGridEditorSByteUpDown : SByteUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorSByteUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorSByteUpDown)));
        }
    }
    ...
    internal class PropertyGridEditorUIntegerUpDown : UIntegerUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorUIntegerUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorUIntegerUpDown)));
        }
    }
    ...
    internal class PropertyGridEditorULongUpDown : ULongUpDown
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(PropertyGridEditorULongUpDown),
                new FrameworkPropertyMetadata(typeof(PropertyGridEditorULongUpDown)));
        }
    }
