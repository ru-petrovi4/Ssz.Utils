...
namespace Antlr4.Runtime
{
    ...
    public class BufferedTokenStream : ITokenStream
    {
        ...
        public virtual void Consume()
        {
            ...
            {
                throw new InvalidDesignTaskException("cannot consume EOF");
            }
            if (Sync(p + 1))
            {
        ...
        /// <summary>
        /// Allowed derived classes to modify the behavior of designTasks which change
        ...
        /// Allowed derived classes to modify the behavior of designTasks which change
        /// the current stream position by adjusting the target token index of a seek
        /// designTask. The default implementation simply returns
        /// <paramref name="i"/>
        /// . If an
