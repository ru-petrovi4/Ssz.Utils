...
namespace Ssz.Operator.Core.Drawings
{
    public abstract class DrawingInfo : EntityInfo, IOwnedDataSerializable, IDsContainer
    {
        ...
        public DrawingInfo(FileInfo fileInfo)
        ...
        public DrawingInfo(FileInfo fileInfo, Guid drawingGuid, string desc,
            ...
            : base(Path.GetFileNameWithoutExtension(fileInfo.Name), drawingGuid, desc, group, previewImageBytes)
        {
            FileInfo = fileInfo;
    ...
    public static class DrawingInfoExtensions
    {
        ...
        {
            return DsProject.Instance.GetFileRelativePath(drawingInfo.FileInfo.FullName);
        }
