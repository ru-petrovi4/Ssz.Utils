...
{
    public partial class BrushConverterTypeEditor : UserControl, ITypeEditor, IPropertyGridItem
    {
        ...
        public BrushConverterTypeEditor()
        {
            InitializeComponent();
        ...
        private void ButtonClick(object? sender, RoutedEventArgs e)
        {
            ...
            if (dialog.ShowDialog() == true) ((PropertyItem) DataContext).Value = dialog.DsBrushConverter;
        }
