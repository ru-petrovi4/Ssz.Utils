...
namespace Ssz.WindowsAPICodePack.Shell
{
    ...
    /// <summary>
    /// Provides a set of flags to be used with <see cref="Ssz.WindowsAPICodePack.Shell.SearchCondition"/> 
    /// to indicate the operation in <see cref="Ssz.WindowsAPICodePack.Shell.SearchConditionFactory"/> methods.
    /// </summary>
    ...
    /// <summary>
    /// Set of flags to be used with <see cref="Ssz.WindowsAPICodePack.Shell.SearchConditionFactory"/>.
    /// </summary>
    public enum SearchConditionType
    {
        ...
        /// constant value using a <see cref="Ssz.WindowsAPICodePack.Shell.SearchConditionOperation"/>.
        /// </summary>
        Leaf = 3,
    }
