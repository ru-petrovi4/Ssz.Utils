...
namespace Ssz.Operator.Core.Utils.Serialization
{
    ...
    internal enum SerializedType : byte
    {
        ...
        OwnedDataSerializableTypedArrayType, 
        ...
        AllFalseOptimizeFlagsType, // Identifies a typed array and how it is optimized
        AllTrueOptimizeFlagsType,
        MiscOptimizeFlagsType,
        TypedArrayType,
