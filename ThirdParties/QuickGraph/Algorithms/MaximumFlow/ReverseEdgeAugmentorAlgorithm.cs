...
namespace QuickGraph.Algorithms.MaximumFlow
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        {
            if (this.Augmented)
                throw new InvalidDesignTaskException("Graph already augmented");
            ...
            foreach (var edge in notReversedEdges)
            {
                ...
                if (!this.VisitedGraph.AddEdge(reversedEdge))
                    throw new InvalidDesignTaskException("We should not be here");
        ...
        {
            if (!this.Augmented)
                throw new InvalidDesignTaskException("Graph is not yet augmented");
