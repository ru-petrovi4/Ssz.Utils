...
namespace Ssz.Utils.Wpf.EventSourceModel
{
    public class AlarmInfoViewModelBase : ViewModelBase
    {
        ...
        public AlarmInfoViewModelBase(AlarmInfoViewModelBase that)
        {
            ...
            _tag = that._tag;
            _parameterPath = that._parameterPath;
            _desc = that._desc;
            _area = that._area;
        ...
        public virtual string ElementId
        {
            ...
            set
            {
                ...
                if (i > 0)
                {
                    ...
                    ParameterPath = value.Substring(i);
                }                
                else
                {
                    Tag = value;
        ...
        /// </summary>
        public virtual string ParameterPath
        {
            get { return _parameterPath; }
            set
            {
                SetValue(ref _parameterPath, value);
                OnPropertyChanged(() => ElementId);
            }
        }
