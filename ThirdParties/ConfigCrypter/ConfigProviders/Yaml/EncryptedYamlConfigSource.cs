...
namespace DevAttic.ConfigCrypter.ConfigProviders.Yaml
{
    ...
    /// </summary>
    public class EncryptedYamlConfigSource : YamlConfigurationSource
    {
        /// <summary>
        ...
        /// </summary>
        public Func<EncryptedYamlConfigSource, ICrypter> CrypterFactory { get; set; } =
        ...
        public EncryptedYamlConfigSource()
        {
            ReloadOnChange = true;
        }
        ...
        {
            base.Build(builder);
            return new EncryptedYamlConfigProvider(this);
        }
    }
}