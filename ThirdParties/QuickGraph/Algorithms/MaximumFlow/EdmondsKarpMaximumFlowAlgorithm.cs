...
namespace QuickGraph.Algorithms.MaximumFlow
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        {
            if (this.Source == null)
                throw new InvalidDesignTaskException("Source is not specified");
            if (this.Sink == null)
                throw new InvalidDesignTaskException("Sink is not specified");
            ...
            foreach (var u in g.Vertices)
                foreach (var e in g.OutEdges(u))
                {
                    ...
                    if (capacity < 0)
                        throw new InvalidDesignTaskException("negative edge capacity");
