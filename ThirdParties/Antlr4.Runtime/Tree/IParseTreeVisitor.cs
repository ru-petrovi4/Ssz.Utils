...
#endif
    {
        /// <summary>Visit a parse tree, and return a user-defined result of the designTask.</summary>
        /// <remarks>Visit a parse tree, and return a user-defined result of the designTask.</remarks>
        /// <param name="tree">
        /// The
        /// <see cref="IParseTree"/>
        /// to visit.
        ...
        /// <summary>Visit a terminal node, and return a user-defined result of the designTask.</summary>
        /// <remarks>Visit a terminal node, and return a user-defined result of the designTask.</remarks>
        /// <param name="node">
        /// The
        ...
        /// <summary>Visit an error node, and return a user-defined result of the designTask.</summary>
        /// <remarks>Visit an error node, and return a user-defined result of the designTask.</remarks>
        /// <param name="node">
        /// The
        /// <see cref="IErrorNode"/>
        /// to visit.
