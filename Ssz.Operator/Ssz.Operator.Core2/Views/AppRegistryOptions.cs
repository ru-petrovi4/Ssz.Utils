...
namespace Ssz.Operator.Core
{
    public static class AppRegistryOptions
    {
            ...
            out List<WindowProps> rootWindowPropsCollection, out string virtualKeyboardType)
        {
            ...
            //    if (touchScreenRect.Width != 0.0 && touchScreenRect.Height != 0.0)
            //        touchScreen = touchScreenRect;
            //}
        ...
        public static void SaveScreensInfo(
            IEnumerable<WindowProps> rootWindowPropsCollection,
        ...
        public static void SaveScreensInfo(PixelRect? touchScreen, TouchScreenMode touchScreenMode)
        {
            //RegistryKey? skSimcodeSszOperator = null;
            //try
            //{
