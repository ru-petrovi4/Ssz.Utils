...
{
    public partial class OneWayToSourceStructConverterTypeEditor : UserControl, ITypeEditor, IPropertyGridItem
    {
        #region private fields

        private IValueDataBinding _dataSourceInfo = null!;

        #endregion

        #region construction and destruction

        public OneWayToSourceStructConverterTypeEditor()
        {
            InitializeComponent();
        ...
        {
            _dataSourceInfo = ((SetValueDsCommandOptions) propertyItem.Instance).ValueInfo;
