...
namespace Antlr4.Runtime.Atn
{
	...
	public ParseInfo(ProfilingATNSimulator atnSimulator)
		...
		/**
		 * Gets the total number of SLL lookahead designTasks across all decisions
		...
		/**
		 * Gets the total number of LL lookahead designTasks across all decisions
		 * made during parsing. This value is the sum of
		...
		/**
		 * Gets the total number of ATN lookahead designTasks for SLL prediction
		...
		/**
		 * Gets the total number of ATN lookahead designTasks for LL prediction
		 * across all decisions made during parsing.
		 */
		...
		/**
		 * Gets the total number of ATN lookahead designTasks for SLL and LL
