  ...
  internal static class Verify
    {
      ...
      [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        ...
        {
            if (null != obj) throw new ArgumentException("The parameter must be null.", name);
        }
        ...
        public static void AreEqual<T>(T expected, T actual, string parameterName, string message)
        {
            if (null == expected)
            {
                ...
                if (null != actual && !actual.Equals(expected)) throw new ArgumentException(message, parameterName);
            }
        ...
        public static void AreNotEqual<T>(T notExpected, T actual, string parameterName, string message)
        {
            ...
            {
                // Two nulls are considered equal, regardless of type semantics.
                if (null == actual || actual.Equals(notExpected)) throw new ArgumentException(message, parameterName);
            }
