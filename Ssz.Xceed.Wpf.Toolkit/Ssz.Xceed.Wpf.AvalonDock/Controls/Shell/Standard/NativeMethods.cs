...
namespace Standard
{
    ...
    internal class PROPVARIANT : IDisposable
    {
        ...
        {
            if (vt == (ushort) VarEnum.VT_LPWSTR) return Marshal.PtrToStringUni(pointerVal);
    ...
    internal struct WTA_OPTIONS
    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields",
            Justification = "Used by native code.")]
        [FieldOffset(0)]
    ...
    internal static class NativeMethods
    {
            ...
            out MSGFLTINFO filterInfo)
        {
            ...
            if (!Utility.IsOSVistaOrNewer) return HRESULT.S_FALSE;
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        [DllImport("gdi32.dll", EntryPoint = "CreateDIBSection", SetLastError = true)]
        private static extern SafeHBITMAP _CreateDIBSectionIntPtr(IntPtr hdc, [In] ref BITMAPINFO bitmapInfo,
            int iUsage, [Out] out IntPtr ppvBits, IntPtr hSection, int dwOffset);
            ...
            int nWidthEllipse, int nHeightEllipse)
        {
            ...
            if (IntPtr.Zero == ret) throw new Win32Exception();
            return ret;
        }
            ...
            IntPtr lpParam)
        {
            ...
            if (IntPtr.Zero == ret) HRESULT.ThrowLastError();
        ...
        {
            // Make this call safe to make on downlevel OSes...
            if (!Utility.IsOSVistaOrNewer) return false;
        ...
        {
            if (!_RemoveMenu(hMenu, (uint) uPosition, (uint) uFlags)) throw new Win32Exception();
        }
        ...
        {
            RECT rc;
            if (!_GetClientRect(hwnd, out rc)) HRESULT.ThrowLastError();
            return rc;
        }
        ...
        public static IntPtr GetStockObject(StockObject fnObject)
        {
            ...
            if (retPtr.ToInt32() == 0) HRESULT.ThrowLastError();
            return retPtr;
        }
        ...
        {
            RECT rc;
            if (!_GetWindowRect(hwnd, out rc)) HRESULT.ThrowLastError();
            return rc;
        }
        ...
        {
            if (8 == IntPtr.Size) return SetClassLongPtr64(hwnd, nIndex, dwNewLong);
        ...
        {
            if (!_SetProcessWorkingSetSize(hProcess, new IntPtr(dwMinimumWorkingSetSize),
                new IntPtr(dwMaximumWorkingSetSize))) throw new Win32Exception();
        }
        ...
        {
            if (8 == IntPtr.Size) return SetWindowLongPtr64(hwnd, nIndex, dwNewLong);
        ...
        public static void SetWindowRgn(IntPtr hWnd, IntPtr hRgn, bool bRedraw)
        {
            ...
            if (0 == err) throw new Win32Exception();
        }
        ...
        public static void UpdateLayeredWindow(
            ...
            ULW dwFlags)
        {
            if (!_UpdateLayeredWindow(hwnd, hdcDst, ref pptDst, ref psize, hdcSrc, ref pptSrc, crKey, ref pblend,
                dwFlags)) HRESULT.ThrowLastError();
        }
        ...
        public static void UpdateLayeredWindow(
            ...
            ULW dwFlags)
        {
            if (!_UpdateLayeredWindowIntPtr(hwnd, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero,
                crKey, ref pblend, dwFlags)) HRESULT.ThrowLastError();
        }
