...
namespace Standard
{
    ...
    internal sealed class ManagedIStream : IStream, IDisposable
    {
        ...
        {
            if (null == _source) throw new ObjectDisposedException("this");
        }
        ...
        public void CopyTo(IStream pstm, long cb, IntPtr pcbRead, IntPtr pcbWritten)
        {
            ...
            if (IntPtr.Zero != pcbRead) Marshal.WriteInt64(pcbRead, cbWritten);

            if (IntPtr.Zero != pcbWritten) Marshal.WriteInt64(pcbWritten, cbWritten);
        }
        ...
        public void Read(byte[] pv, int cb, IntPtr pcbRead)
        {
            ...
            if (IntPtr.Zero != pcbRead) Marshal.WriteInt32(pcbRead, cbRead);
        }
        ...
        public void Seek(long dlibMove, int dwOrigin, IntPtr plibNewPosition)
        {
            ...
            if (IntPtr.Zero != plibNewPosition) Marshal.WriteInt64(plibNewPosition, position);
        }
        ...
        public void Write(byte[] pv, int cb, IntPtr pcbWritten)
        {
            ...
            if (IntPtr.Zero != pcbWritten) Marshal.WriteInt32(pcbWritten, cb);
        }
