...
using Ssz.WindowsAPICodePack.Controls;
using Ssz.WindowsAPICodePack.Dialogs.Controls;
using Ssz.WindowsAPICodePack.Shell;
using Ssz.WindowsAPICodePack.Shell.Resources;
using MS.WindowsAPICodePack.Internal;
using System.Collections.Generic;

namespace Ssz.WindowsAPICodePack.Dialogs
{
    /// <summary>
    ...
    public abstract class CommonFileDialog : IDialogControlHost, IDisposable
    {
        ...
        /// </summary>
        /// <value>A <see cref="Ssz.WindowsAPICodePack.Shell.ShellObject"></see> object.</value>
        ...
        /// <summary>
        /// Sets the location (<see cref="Ssz.WindowsAPICodePack.Shell.ShellContainer">ShellContainer</see> 
