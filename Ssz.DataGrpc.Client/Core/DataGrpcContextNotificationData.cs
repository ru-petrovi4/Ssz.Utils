...
namespace Ssz.DataGrpc.Client.Core
{
    ...
    /// </summary>
    public class DataGrpcContextNotificationData : EventArgs
    {
        #region construction and destruction

        /// <summary>
        ///     This constructor creates an DataGrpcContextNotificationData object from the reason for the
        ...
        public DataGrpcContextNotificationData(DataGrpcContextNotificationType reasonForNotification, object? data)
        {
        ...
        /// </summary>
        public DataGrpcContextNotificationType ReasonForNotification
        {
        ...
        /// </summary>
        private readonly DataGrpcContextNotificationType _reasonForNotification;
