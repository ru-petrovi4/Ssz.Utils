...
namespace Ssz.Operator.Core.Commands.DsCommandOptions
{
        ...
        IDsItem
    {
        ...
        public override void SerializeOwnedData(SerializationWriter writer, object? context)
        {
            using (writer.EnterBlock(8))
            {
                ...
                writer.WriteNullable(ContentLeft);
                writer.WriteNullable(ContentTop);
                ...
                {                    
                    case 7:
                        try
                        {
                            ...
                            ContentLeft = reader.ReadNullableDouble();
                            ContentTop = reader.ReadNullableDouble();
    ...
    public enum PlayWindowStyle
    {
        ...
        //     A System.Windows.Navigation.NavigationWindow with a System.Windows.Window.WindowStyle
        //     of System.Windows.WindowStyle.None will still display the navigation user
        //     interface (UI).
        None = 0,
    ...
    public class WindowProps : ShowWindowDsCommandOptions
    {
        ...
        public void CombineWith(WindowProps that)
        {
            ...
            if (that.ContentLeft.HasValue) ContentLeft = that.ContentLeft;
            if (that.ContentTop.HasValue) ContentTop = that.ContentTop;
