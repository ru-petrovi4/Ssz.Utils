...
namespace Ssz.Xceed.Wpf.Toolkit.Primitives
{
    public abstract class InputBase : Control
  {
    ...
    public static readonly DependencyProperty CultureInfoProperty = DependencyProperty.Register( "CultureInfo", typeof( CultureInfo ), typeof( InputBase ), new UIPropertyMetadata( CultureInfo.InvariantCulture, OnCultureInfoChanged ) );
