namespace Ssz.DataGrpc.Common
{
    ...
    ///         when the server is unable to retrieve the value from the underlying system.
    ///     </para>
    ///     <para>
    ...
    ///         in Xi.Contracts.Contstants.XiStatusCodeLimitBits.  This layout is summarized as follows.
    ///     </para>
    ...
    ///         separately defined in Xi.Contracts.Contstants.XiStatusCodeLimitBits.
    ///     </para>
    ///     <para>
    ///         This class defines values for the 2-bit Status Group Bits, the 6-bit Status Bits, and
    ///         additional values for their manipulation, such as bit masks and shift values.
    ///     </para>
    ///     <para>
    ...
    ///         the GG bits for the Uncertain value are 01. Therefore, the two definitions for it are:
    ///     </para>
    ...
    ///         the data object value from the underlying OPC Classic server or from the underlying system.
    ///     </para>
    ///     <para>
    ...
    ///         Quality returned with the data object value to construct the Xi Status Code.
    ///     </para>
    ///     <para>
    ...
    ///         details on the encoding of HRESULT values.
    ///     </para>
    /// </summary>
    public enum DataGrpcStatusCodeStatusBits : uint
    {
