...
namespace Ssz.Xceed.Wpf.Toolkit.PropertyGrid
{
  public abstract class DescriptorPropertyDefinitionBase : DependencyObject
  {
    ...
    private string _valuePropertyPath;
    private string _isValueEditorEnabledPropertyPath;
    ...
    {
        var bindingExpressionBase = BindingOperations.GetBindingExpressionBase(this, DescriptorPropertyDefinitionBase.ValueProperty);
    ...
    internal string ValuePropertyPath
    {
        get { return _valuePropertyPath; }        
    }

    internal string IsValueEditorEnabledPropertyPath
    {
        get { return _isValueEditorEnabledPropertyPath; }        
    }
    ...
    {
      _valuePropertyPath = ComputeValuePropertyPath();
      _isValueEditorEnabledPropertyPath = ComputeIsValueEditorEnabledPropertyPath();
