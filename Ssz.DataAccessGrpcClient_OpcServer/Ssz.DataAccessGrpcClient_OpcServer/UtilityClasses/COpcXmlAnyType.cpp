...
// Alloc
void AnyType::Alloc(OpcXml::Type eElement, UINT uLength)
{
    Clear();
...
// CopyTo
bool AnyType::CopyTo(AnyType& cValue, OpcXml::Type eNewType)
{
    if (eType == eNewType)
    {
        cValue = *this;
...
// Get
bool AnyType::Get(OpcXml::Boolean& value) const
{
...
// Get
bool AnyType::Get(OpcXml::SByte& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Byte& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Short& value) const
{
...
// Get
bool AnyType::Get(OpcXml::UShort& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Int& value) const
{
...
// Get
bool AnyType::Get(OpcXml::UInt& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Long& value) const
{
...
// Get
bool AnyType::Get(OpcXml::ULong& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Float& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Double& value) const
{
...
// Get
bool AnyType::Get(OpcXml::Decimal& value) const
{
...
// Get
bool AnyType::Get(OpcXml::DateTime& value) const
{
...
// Get
bool AnyType::Get(OpcXml::String& value) const
{
...
// Set
void AnyType::Set(OpcXml::Boolean value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::SByte value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Byte value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Short value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::UShort value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Int value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::UInt value)
{
    Clear();
...
void AnyType::Set(unsigned long value)
{
    ...
    eType     = XML_UINT;
    iLength   = -1;
    uintValue = (OpcXml::UInt)value;
}

// Set
void AnyType::Set(OpcXml::Long value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::ULong value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Float value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Double value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::Decimal value)
{
    Clear();
...
// Set
void AnyType::Set(OpcXml::DateTime value)
{
    Clear();
...
// Set
void AnyType::Set(const OpcXml::String value)
{
    Clear();
