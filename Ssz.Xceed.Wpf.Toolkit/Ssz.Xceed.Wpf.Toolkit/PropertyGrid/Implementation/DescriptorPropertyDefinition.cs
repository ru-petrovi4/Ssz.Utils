...
namespace Ssz.Xceed.Wpf.Toolkit.PropertyGrid
{
  internal class DescriptorPropertyDefinition : DescriptorPropertyDefinitionBase
  {
    ...
    {
        return PropertyDescriptor.IsReadOnly || PropertyDescriptor.Attributes.OfType<ReadOnlyInEditorAttribute>().Any();
    }
    ...
    {
        return this.ComputeValuePropertyPathForItem(PropertyDescriptor);
    }

    protected override string ComputeIsValueEditorEnabledPropertyPath()
    {
        return this.ComputeIsValueEditorEnabledPropertyPathForItem(PropertyDescriptor);
    }
