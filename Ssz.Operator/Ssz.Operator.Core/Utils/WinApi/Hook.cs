...
namespace Ssz.Operator.Core.Utils.WinApi
{
    ...
    public class Hook : Component
    {
        ...
        ///     Creates a new hook.
        /// </summary>
        public Hook(IDsContainer container)
            : this()
        {
            container.Add(this);
        }*/
        ...
        {
            //DsProject.LoggersSet.Logger.Critical("ManagedWinapiNativeHelper.dll now excluded from bins! Include it again to restore functionality!");
            return new IntPtr();
        }
