...
namespace Ssz.Operator.Core
{
    public static class SerializationExtensions
    {
        ...
        public static void WriteNullablePixelPoint(this SerializationWriter writer, PixelPoint? value)
        {
            if (value is null)
            {
                writer.Write(false);
        ...
        public static PixelPoint? ReadNullablePixelPoint(this SerializationReader reader)
        {
