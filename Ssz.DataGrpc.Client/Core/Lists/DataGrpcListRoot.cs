...
namespace Ssz.DataGrpc.Client.Core.Lists
{
    ...
    /// </summary>
    public abstract class DataGrpcListRoot : IDisposable
    {
        ...
        protected DataGrpcListRoot(DataGrpcContext context)
        {
            _context = context;
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {                
                if (_context.ServerContextIsOperational)
                {
                    try
                    {
        ...
        {
            if (Disposed) throw new ObjectDisposedException("Cannot access a disposed DataGrpcListRoot.");
            
            if (CallbackIsEnabled != enable)
            {
                CallbackIsEnabled = _context.EnableListCallback(ListServerAlias, enable);                
            }
        ...
        ///         that are currently enabled (see the DataGrpcElementValueList EnableListElementUpdating() method), mark them as changed (even
        ...
        public uint TouchList()
        {
            ...
            return _context.TouchList(ListServerAlias);
        }

        /// <summary>
        ///     This property provides the DataGrpc Context to which this list belongs.
        /// </summary>
        public DataGrpcContext Context
        {
            get { return _context; }
        }

        /// <summary>
        ///     The Client LocalId provides a handle by which this DataGrpc List is known within
        ...
        /// <summary>
        ///     The Server LocalId provides a handle by which this DataGrpc List is known within
        ///     the server code.  This value is established by the server code.
        /// </summary>
        public uint ListServerAlias { get; set; }

        /// <summary>
        ///     This property identifies the Standard DataGrpc List Type of this list.
        /// </summary>
        ...
        /// <summary>
        ///     This property is provided for the DataGrpc Client application to associate this list
        ...
        /// </summary>
        private readonly DataGrpcContext _context;        
