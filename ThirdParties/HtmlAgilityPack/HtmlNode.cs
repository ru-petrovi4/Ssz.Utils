		...
		public void SetParent(HtmlNode parent)
		{
			...
			if (OwnerDocument.OptionMaxNestedChildNodes > 0)
			{
				...
				if (Depth > OwnerDocument.OptionMaxNestedChildNodes)
					throw new Exception(string.Format("Document has more than {0} nested tags. This is likely due to the graphic not closing tags properly.", OwnerDocument.OptionMaxNestedChildNodes));
			}
		}
