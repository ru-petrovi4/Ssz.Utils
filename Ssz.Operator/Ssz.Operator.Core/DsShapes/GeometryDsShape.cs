...
namespace Ssz.Operator.Core.DsShapes
{
    public class GeometryDsShape : DsShapeBase
    {
        ...
        [DsCategory(ResourceStrings.AppearanceCategory)]
        [DsDisplayName(ResourceStrings.GeometryDsShapeStrokeEndLineCap)]
        [PropertyOrder(9)]
        public PenLineCap StrokeEndLineCap
        {
            get => _strokeEndLineCap;
            set => SetValue(ref _strokeEndLineCap, value);
        }
        ...
        public override void SerializeOwnedData(SerializationWriter writer, object? context)
        {
            ...
            using (writer.EnterBlock(6))
            {
                ...
                writer.Write((int) StrokeEndLineCap);
            ...
            using (Block block = reader.EnterBlock())
            {
                switch (block.Version)
                {
                    case 6:
                        ...
                        StrokeEndLineCap = (PenLineCap) reader.ReadInt32();
