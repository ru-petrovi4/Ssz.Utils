...
{
    public abstract class DataGrpcElementListItemsManagerBase<TDataGrpcListItem, TDataGrpcList>
        where TDataGrpcListItem : DataGrpcElementListItemBase
        where TDataGrpcList : DataGrpcElementListBase<TDataGrpcListItem>
    {
        #region construction and destruction

        protected DataGrpcElementListItemsManagerBase(ILogger<DataGrpcProvider> logger, bool unsubscribeItemsFromServer)
        {
            Logger = logger;
