...
namespace Ssz.Xceed.Wpf.Toolkit.Core.Utilities
{
    ...
    {
        public static readonly DependencyProperty OpenOnMouseLeftButtonClickProperty =
            DependencyProperty.RegisterAttached("OpenOnMouseLeftButtonClick", typeof(bool),
                typeof(ContextMenuUtilities), new FrameworkPropertyMetadata(false, OpenOnMouseLeftButtonClickChanged));
        ...
        public static void OpenOnMouseLeftButtonClickChanged(DependencyObject sender,
