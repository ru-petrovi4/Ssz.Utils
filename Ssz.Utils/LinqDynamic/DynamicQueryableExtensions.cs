...
namespace System.Linq.Dynamic.Core
{
    ...
    public static class DynamicQueryableExtensions
    {
        ...
        public static IQueryable GroupBy(this IQueryable source, ParsingConfig config, string keySelector, string resultSelector, IEqualityComparer? equalityComparer, params object?[] args)
        {
            return InternalGroupBy(source, config, keySelector, resultSelector, equalityComparer, args);
        }

        internal static IQueryable InternalGroupBy(IQueryable source, ParsingConfig config, string keySelector, string resultSelector, IEqualityComparer? equalityComparer, params object?[] args)
        {
            // Check.NotNull(source, nameof(source));            
            Check.NotEmpty(keySelector, nameof(keySelector));
            Check.NotEmpty(resultSelector, nameof(resultSelector));

            bool createParameterCtor = config.EvaluateGroupByAtDatabase ? config.EvaluateGroupByAtDatabase : SupportsLinqToObjects(config, source);
        ...
        public static IQueryable GroupBy(this IQueryable source, string keySelector, string resultSelector, IEqualityComparer equalityComparer, params object?[] args)
        {
        ...
        {
            return InternalGroupBy(source, config, keySelector, resultSelector, equalityComparer);
        }
        ...
        public static IQueryable GroupJoin(this IQueryable outer, ParsingConfig config, IEnumerable inner, string outerKeySelector, string innerKeySelector, string resultSelector, params object?[] args)
        {
            ...
            bool createParameterCtor = config.EvaluateGroupByAtDatabase ? true : SupportsLinqToObjects(config, outer);
        ...
        private static TResult Execute<TResult>(MethodInfo operatorMethodInfo, IQueryable source)
        {
            ...
            return (TResult)Convert.ChangeType(result, typeof(TResult))!; // TODO
        }
...
///// </example>
////[PublicAPI]
//public static IQueryable GroupBy(this IQueryable source, ParsingConfig config, string keySelector, string resultSelector, params object?[] args)
//{
