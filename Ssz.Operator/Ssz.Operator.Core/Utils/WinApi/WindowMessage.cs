...
{  
    ...
    public enum WindowMessageParameter : uint
    {
        ...
        PBT_APMRESUMECRITICAL = 0x6, // Notifies applications that the system has resumed toolkitOperation.
        PBT_APMRESUMESUSPEND = 0x7, // Notifies applications that the system has resumed toolkitOperation after being suspended.
