    ...
    public sealed class KeyModifierCollectionConverter : TypeConverter
    {
            ...
            CultureInfo cultureInfo, object value)
        {
            ...
            else
            {
                ...
                foreach (var token in stringValue.Split(new[] {'+', ' ', '|', ','},
                    StringSplitOptions.RemoveEmptyEntries))
                    result.Add((KeyModifier) _keyModifierConverter.ConvertFrom(typeDescriptorContext, cultureInfo,
                        token));
            ...
            CultureInfo cultureInfo, object value, Type destinationType)
        {
            ...
            if (destinationType == typeof(string))
            {
                ...
                foreach (var modifier in (KeyModifierCollection) value)
                {
        ...
        {
            var ci = typeof(KeyModifierCollection).GetConstructor(new Type[] { });
