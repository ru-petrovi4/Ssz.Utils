        ...
        ICloneable
    {
        ...
        public Point CenterRelativePosition
        {
            ...
            set
            {
                ...
                value.X = Math.Round(value.X, 6);
                value.Y = Math.Round(value.Y, 6);
                SetValue(ref _centerRelativePosition, value);
            }
        }
        ...
        public double LeftNotTransformed
        {
            ...
            set
            {
                var centerPoint = _centerInitialPosition;

                centerPoint.X = value + _widthInitial * CenterRelativePosition.X;

                CenterInitialPosition = centerPoint;
            }
        }
        ...
        public double TopNotTransformed
        {
            ...
            set
            {
                ...
                centerPoint.Y = value + _heightInitial * CenterRelativePosition.Y;
        ...
        public Rect GetBoundingRect()
        {
            if (!_boundingRect.HasValue)
            {
                ...
                else
                {
                    ...
                    var rect = new Rect(LeftNotTransformed - center.X,
                        TopNotTransformed - center.Y,
                        _widthInitial,
                        _heightInitial);
                    var boundingRect = GetTransformGroup().TransformBounds(rect);
                    boundingRect.Offset(center.X, center.Y);
        ...
        public void SetBoundingRect(Rect newRect)
        {
            ...
            else
            {
                ...
                if (a == 0.0)
                {
                    newRect.Offset(-origCenter.X, -origCenter.Y);
                    newRect = GetInverseTransformGroup().TransformBounds(newRect);
                    newRect.Offset(origCenter.X, origCenter.Y);
                    WidthInitial = newRect.Width;
                    HeightInitial = newRect.Height;
                }
        ...
        public GeneralTransform GetInverseTransformGroup()
        {
            if (_inverseTransformGroup is null) _inverseTransformGroup = GetTransformGroup().Inverse;
        ...
        private GeneralTransform? _inverseTransformGroup;
