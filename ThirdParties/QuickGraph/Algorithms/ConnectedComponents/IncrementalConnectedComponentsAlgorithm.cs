...
namespace QuickGraph.Algorithms.ConnectedComponents
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        {
            throw new InvalidDesignTaskException("vertex removal not supported for incremental connected components");
        }

        void VisitedGraph_EdgeRemoved(TEdge e)
        {
            throw new InvalidDesignTaskException("edge removal not supported for incremental connected components");
        }
    }
}
