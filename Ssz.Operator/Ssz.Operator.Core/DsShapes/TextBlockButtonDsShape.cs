            ...
            using (Block block = reader.EnterBlock())
            {
                switch (block.Version)
                {
                    case 1:
                        ...
                        if (base.HorizontalContentAlignment == HorizontalAlignment.Center)
                            TextAlignment = TextAlignment.Center;
                        else if (base.HorizontalContentAlignment == HorizontalAlignment.Left)
                            TextAlignment = TextAlignment.Left;
                        else if (base.HorizontalContentAlignment == HorizontalAlignment.Right)
