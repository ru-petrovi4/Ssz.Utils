    ...
    internal sealed class OptionMap
    {
        ...
        public OptionInfo? this[string? key]
        {
            ...
            set
            {
                ...
                if (value != null && value.HasBothNames)
                {
                    // ReSharper disable PossibleInvalidOperationException
                    _names[value.LongName] = new string(value.ShortName ?? '0', 1);
            ...
            bool? mutualExclusiveness)
        {
            ...
            var parserState = property.GetValue(options, null) as IParserState;
            if (parserState == null)
            {
                return;
            }
        ...
        {
            if (_mutuallyExclusiveSetMap == null)
            {
                return true;
            }
