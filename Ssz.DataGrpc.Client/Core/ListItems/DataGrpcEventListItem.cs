...
namespace Ssz.DataGrpc.Client.Core.ListItems
{
    ...
    /// </summary>
    public class DataGrpcEventListItem : DataGrpcListItemRoot
    {
        #region construction and destruction

        /// <summary>
        ///     The constructor for DataGrpcEventListElements
        /// </summary>
        ...
        public DataGrpcEventListItem(EventMessage eventMessage, string? messageKey = null)
        {
