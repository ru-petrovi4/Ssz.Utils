                ...
                case MemberTypes.Property:
                {
                    ...
                    if (properties.Length > 1)
                    {
                        for (int i = 0; i < properties.Length; i++)
                        {
                            ...
                            {
                                if (((PropertyInfo)properties[i]).SerializationToString().Equals(m_signature2))
                                    return properties[i];
                            }
                            else
                            {
                ...
                case MemberTypes.Constructor:
                {
                    ...
                    if (constructors.Length > 1)
                    {
                        for (int i = 0; i < constructors.Length; i++)
                        {
                            if (m_signature2 != null)
                            {
                                if (((ConstructorInfo)constructors[i]).SerializationToString().Equals(m_signature2))
                ...
                case MemberTypes.Method:
                {
                    ...
                    else if (methods.Length > 1)
                    {
                        for (int i = 0; i < methods.Length; i++) 
                        {
                            if (m_signature2 != null)
                            {
                                if (((MethodInfo)methods[i]).SerializationToString().Equals(m_signature2))
                                {
                            ...
                            if (genericArguments != null && methods[i].IsGenericMethod)
                            {
                                if (methods[i].GetGenericArguments().Length == genericArguments.Length)
                                {
                                    ...
                                    if (m_signature2 != null)
                                    {
                                        if (((MethodInfo)candidateMethod).SerializationToString().Equals(m_signature2))
                                        {
