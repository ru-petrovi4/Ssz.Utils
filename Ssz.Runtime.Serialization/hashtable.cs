...
namespace Ssz.Collections {
    ...
    public class Hashtable : IDictionary, ISerializable, IDeserializationCallback, ICloneable {
        ...
        */
        ...
        //        }
        //        else {
        //            throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Arg_CannotMixComparisonInfrastructure"));
        //        }                
        //    }
        //    set
        //    {
        ...
        public Hashtable(int capacity, float loadFactor) {
            if (capacity < 0)
                throw new ArgumentOutOfRangeException("capacity", Ssz.Runtime.Serialization.Environment.GetResourceString("ArgumentOutOfRange_NeedNonNegNum"));
            if (!(loadFactor >= 0.1f && loadFactor <= 1.0f))
                throw new ArgumentOutOfRangeException("loadFactor", Ssz.Runtime.Serialization.Environment.GetResourceString("ArgumentOutOfRange_HashtableLoadFactor", .1, 1.0));
            ...
            if (rawsize > Int32.MaxValue)
                throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Arg_HTCapacityOverflow"));
        ...
        //    if (d==null)
        //        throw new ArgumentNullException("d", Ssz.Runtime.Serialization.Environment.GetResourceString("ArgumentNull_Dictionary"));
        //    Contract.EndContractBlock();
        ...
        {
            if (array == null)
                throw new ArgumentNullException("array", Ssz.Runtime.Serialization.Environment.GetResourceString("ArgumentNull_Array"));
            if (array.Rank != 1)
                throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Arg_RankMultiDimNotSupported"));
            if (arrayIndex < 0) 
                throw new ArgumentOutOfRangeException("arrayIndex", Ssz.Runtime.Serialization.Environment.GetResourceString("ArgumentOutOfRange_NeedNonNegNum"));
            if (array.Length - arrayIndex < Count)
                throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Arg_ArrayPlusOffTooSmall"));
            Contract.EndContractBlock();
        ...
        private void Insert (Object key, Object nvalue, bool add) {
            ...
            do {
                ...
                if (((buckets[bucketNumber].hash_coll & 0x7FFFFFFF) == hashcode) && 
                    ...
                    if (add) {
                        throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Argument_AddingDuplicate__", buckets[bucketNumber].key, key));
                    }
#if !FEATURE_CORECLR
                    Thread.BeginCriticalRegion();
#endif          
            ...
            throw new InvalidOperationException(Ssz.Runtime.Serialization.Environment.GetResourceString("InvalidOperation_HashInsertFailed"));
        }
        ...
        public virtual void Remove(Object key) {
            ...
            //throw new ArgumentException(Ssz.Runtime.Serialization.Environment.GetResourceString("Arg_RemoveArgNotFound"));
        }
...
#pragma warning restore 618
            ...
            info.AddValue(ValuesName, serValues, typeof(Object[]));
                ...
                if (version != oldVersion)
                    throw new InvalidOperationException(Ssz.Runtime.Serialization.Environment.GetResourceString("ResId.InvalidOperation_EnumFailedVersion"));
        }
        }
        ...
        public virtual void OnDeserialization(Object sender) {
            ...
            if (siInfo==null) {
                throw new SerializationException(Ssz.Runtime.Serialization.Environment.GetResourceString("Serialization_InvalidOnDeser"));
            }
...
#pragma warning restore 618        
            ...
            if (serKeys==null) {
                throw new SerializationException(Ssz.Runtime.Serialization.Environment.GetResourceString("Serialization_MissingKeys"));
            }
            if (serValues==null) {
                throw new SerializationException(Ssz.Runtime.Serialization.Environment.GetResourceString("Serialization_MissingValues"));
            }
            if (serKeys.Length!=serValues.Length) {
                throw new SerializationException(Ssz.Runtime.Serialization.Environment.GetResourceString("Serialization_KeyValueDifferentSizes"));
            }
            for (int i=0; i<serKeys.Length; i++) {
                if (serKeys[i]==null) {
                    throw new SerializationException(Ssz.Runtime.Serialization.Environment.GetResourceString("Serialization_NullKey"));
                }
        ...
        private class HashtableEnumerator : IDictionaryEnumerator, ICloneable
        {
            ...
            public virtual Object Key {
                get {
                    if (current == false) throw new InvalidOperationException(Ssz.Runtime.Serialization.Environment.GetResourceString("ResId.InvalidOperation_EnumNotStarted"));
                    return currentKey;
                }
            }
            
            public virtual bool MoveNext() {
                if (version != hashtable.version) throw new InvalidOperationException(Ssz.Runtime.Serialization.Environment.GetResourceString("ResId.InvalidOperation_EnumFailedVersion"));
                while (bucket > 0) {
                    bucket--;
            ...
            public virtual DictionaryEntry Entry {
                get {
                    if (current == false) throw new InvalidOperationException(Ssz.Runtime.Serialization.Environment.GetResourceString("ResId.InvalidOperation_EnumOpCantHappen"));
