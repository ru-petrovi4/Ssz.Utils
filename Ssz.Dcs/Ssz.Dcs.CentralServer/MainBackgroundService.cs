...
public class MainBackgroundService : BackgroundService
{
    ...
    public MainBackgroundService(ILogger<MainBackgroundService> logger, ServerWorker serverWorker)
    {
        Logger = logger;
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        _serverWorker.InitializeAddonsManager();
        ...
        _serverWorker.CloseAddonsManager();
