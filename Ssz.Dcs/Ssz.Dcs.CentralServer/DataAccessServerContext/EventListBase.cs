...
namespace Ssz.Dcs.CentralServer
{
    ...
    public class EventListBase : ServerListRoot
    {
        ...
        public EventListBase(DataAccessServerWorkerBase serverWorker, ServerContext serverContext, uint listClientAlias, CaseInsensitiveOrderedDictionary<string?> listParams)
