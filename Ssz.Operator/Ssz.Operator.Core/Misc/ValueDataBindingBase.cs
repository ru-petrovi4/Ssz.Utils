...
namespace Ssz.Operator.Core
{
        ...
        ICloneable, IOwnedDataSerializable, IDsItem, ISupportsUndo, IDisposable, INotifyPropertyChanged
    {
        ...
        object? GetParsedConstObject(IDsContainer? container);


        ValueConverterBase GetConverterOrDefaultConverter(IDsContainer? container);
    ...
    public abstract class ValueDataBindingBase<T> : DisposableViewModelBase, IValueDataBinding
    {
        ...
        public virtual object? GetParsedConstObject(IDsContainer? container)
        {
            if (StringHelper.IsNullOrEmptyString(ConstValue)) return FallbackValue;
            return ConstValue;
        }
        ...
        public virtual ValueConverterBase GetConverterOrDefaultConverter(IDsContainer? container)
        {
