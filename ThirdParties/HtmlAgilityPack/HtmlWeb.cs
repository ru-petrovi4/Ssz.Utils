...
/// </summary>
        ...
        //        _mimeTypes.Add(".asx", "video/x-ms-asf-addon");
        ...
        //        _mimeTypes.Add(".mpc", "application/x-dsSolution");
        ...
        //        _mimeTypes.Add(".mpp", "application/vnd.ms-dsSolution");
        //        _mimeTypes.Add(".mpt", "application/x-dsSolution");
        //        _mimeTypes.Add(".mpv", "application/x-dsSolution");
        //        _mimeTypes.Add(".mpx", "application/x-dsSolution");
        ...
        //        _mimeTypes.Add(".pm4", "application/x-graphicmaker");
        //        _mimeTypes.Add(".pm5", "application/x-graphicmaker");
        ...
        //        _mimeTypes.Add(".ra", "audio/x-pn-realaudio-addon");
        ...
        //        _mimeTypes.Add(".rmp", "audio/x-pn-realaudio-addon");
        ...
        //        _mimeTypes.Add(".rpm", "audio/x-pn-realaudio-addon");
        ...
        //        _mimeTypes.Add(".vqe", "audio/x-twinvq-addon");
        //        _mimeTypes.Add(".vqf", "audio/x-twinvq");
        //        _mimeTypes.Add(".vql", "audio/x-twinvq-addon");
        ...
        /// <summary>
        /// Gets or Sets the size of the buffer used for memory toolkitOperations.
        /// </summary>
...
/// <returns>A new HTML document.</returns>
        ...
        public HtmlDocument LoadFromBrowser(string url, Func<object, bool> isBrowserScriptCompleted = null)
        {
            ...
            if (system_windows_forms == null)
            {
                ...
                {
                    throw new Exception(
                        "Oops! No reference to System.Windows.Forms have been loaded. Make sure your dsSolution load any type from this assembly to make sure the reference is added to the domain assemblies list. Example: `var webBrowserType = typeof(WebBrowser);`");
                }
            }
            ...
            Uri uri = new Uri(url);
            HtmlDocument doc = new HtmlDocument();
            string timeoutError = "WebBrowser Execution Timeout Expired. The timeout period elapsed prior to completion of the toolkitOperation. To avoid this error, increase the WebBrowserTimeout value or set it to 0 (unlimited).";
