...
namespace Ssz.Runtime.Serialization {
    ...
    public class SszObjectManager {
        ...
        public SszObjectManager(ISurrogateSelector selector, StreamingContext context) : this(selector, context, true, false) {
        }

       //[System.Security.SecurityCritical]  // auto-generated
        internal SszObjectManager(ISurrogateSelector selector, StreamingContext context, bool checkSecurity, bool isCrossAppDomain) {
            if (checkSecurity) {
       ...
       //[System.Security.SecurityCritical]  // auto-generated
        private bool DoValueTypeFixup(System.Reflection.FieldInfo memberToFix, ObjectHolder holder, Object value) {
            ...
            System.Reflection.FieldInfo[] fieldsTemp=new System.Reflection.FieldInfo[4];
            ...
            while (holder.RequiresValueTypeFixup) {
                ...
                if ((currentFieldIndex + 1)>=fieldsTemp.Length) {
                    System.Reflection.FieldInfo[] temp = new System.Reflection.FieldInfo[fieldsTemp.Length * 2];
                ...
                if (currFixup.ParentField!=null) {
                    System.Reflection.FieldInfo parentField = currFixup.ParentField;
            ...
            if (!(holder.ObjectValue is Array) && holder.ObjectValue!=null) {
              ...
              if (fixupObj==null) {
                  ...
                  SszFormatterServices.SerializationSetValue(memberToFix, fixupObj, value);
                  return true;
              }
#endif
            ...
            if (currentFieldIndex!=0) {
                ...
                fields = new System.Reflection.FieldInfo[currentFieldIndex];
                for (int i=0; i<currentFieldIndex; i++) {
                    System.Reflection.FieldInfo fieldInfo = fieldsTemp[(currentFieldIndex - 1 - i)];
                ...
                if (memberToFix != null)
                    ...
                    ((System.Reflection.FieldInfo)memberToFix).SetValueDirect(typedRef, value);
                else
        ...
        void DumpValueTypeFixup(object obj, System.Reflection.FieldInfo[] intermediateFields, System.Reflection.FieldInfo memberToFix, object value){
                ...
                if (fixups!=null) {
                    for (int i=0; i<fixups.m_count; i++) {
                        ...
                        if (GetCompletionInfo(fixups.m_values[i], out tempObjectHolder, out fixupInfo, bObjectFullyComplete)) {
                            ...
                            {
                                typeof(SerializationInfo).GetMethod("UpdateValue").Invoke(si, new[] { (String)fixupInfo, holderValue, typeof(MarshalByRefObject) });                                //si.AddValue((String)fixupInfo, holderValue, typeof(MarshalByRefObject));
                            }
                    ...
                    if (GetCompletionInfo(currentFixup, out tempObjectHolder, out fixupInfo, bObjectFullyComplete)) {
                        ...
                        case FixupHolder.MemberFixup:
                            ...
                            if (tempMember.MemberType==MemberTypes.Field) {
                                ...
                                if (holder.RequiresValueTypeFixup && holder.ValueTypeFixupPerformed) {
                                    if (!DoValueTypeFixup((System.Reflection.FieldInfo)tempMember, holder, tempObjectHolder.ObjectValue)) {
                                        throw new SerializationException(SszEnvironment.GetResourceString("Serialization_PartialValueTypeFixup"));
                                    }
                                } else {
                                        SszFormatterServices.SerializationSetValue(tempMember, holder.ObjectValue, tempObjectHolder.ObjectValue);
                                }
       ...
       //[System.Security.SecurityCritical]  // auto-generated_required
        ...
        {
            ObjectHolder temp;
            Contract.Assert(member == null || member is System.Reflection.FieldInfo, "RegisterString - member is FieldInfo");
            Contract.Assert((FindObjectHolder(objectID) == null), "RegisterString - FindObjectHolder(objectID) == null");

            temp = new ObjectHolder(obj, objectID, info, null, idOfContainingObj, (System.Reflection.FieldInfo)member, null);
       ...
       //[System.Security.SecurityCritical]  // auto-generated_required
        public void RegisterObject(Object obj, long objectID, SerializationInfo info, long idOfContainingObj, MemberInfo member, int[] arrayIndex) {
            ...
            if (member != null && !(member is System.Reflection.FieldInfo) && !(member is SerializationFieldInfo)) {
            ...
            if (temp==null) { 
                ...
                temp = new ObjectHolder(obj, objectID, info, surrogate, idOfContainingObj, (System.Reflection.FieldInfo)member, arrayIndex);
                AddObjectHolder(temp);
            ...
            temp.UpdateData(obj, info, surrogate, idOfContainingObj, (System.Reflection.FieldInfo)member, arrayIndex, this);
...
//#endif                    
        ...
        **Exceptions: None.  This is internal-only, so all checking should have been done by this time.
        ...
        public virtual void RecordFixup(long objectToBeFixed, MemberInfo member, long objectRequired) {
            ...
            if (!(member is System.Reflection.FieldInfo) && !(member is SerializationFieldInfo)) {
    ...
    internal sealed class ObjectHolder {
        ...
        internal ObjectHolder(Object obj, long objID, SerializationInfo info, 
                              ISerializationSurrogate surrogate, long idOfContainingObj, System.Reflection.FieldInfo field, int[] arrayIndex) {
        ...
        internal void DecrementFixupsRemaining(SszObjectManager manager) {
        ...
        **Exceptions: None.
        ==============================================================================*/
        internal void AddFixup(FixupHolder fixup, SszObjectManager manager) {
        ...
        **Exceptions: None.  Asserts only.
        ==============================================================================*/
        private void UpdateDescendentDependencyChain(int amount, SszObjectManager manager) {
        ...
        **Exceptions: None. Asserts only.
        ==============================================================================*/
       //[System.Security.SecurityCritical]  // auto-generated
        internal void UpdateData(Object obj, SerializationInfo info, ISerializationSurrogate surrogate, long idOfContainer, System.Reflection.FieldInfo field, int[] arrayIndex, SszObjectManager manager) {
       ...
       //[System.Security.SecurityCritical]  // auto-generated
        internal void SetObjectValue(Object obj, SszObjectManager manager) {
            m_object = obj;
