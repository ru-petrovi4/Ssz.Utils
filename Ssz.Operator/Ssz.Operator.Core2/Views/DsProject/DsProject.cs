...
namespace Ssz.Operator.Core
{
        ...
        IUsedAddonsInfo
    {
        ...
        public async Task<CaseInsensitiveOrderedDictionary<DsPageDrawingInfo>> GetAllDsPageDrawingInfosAsync(
        ...
        public async Task<CaseInsensitiveOrderedDictionary<DsShapeDrawingInfo>> GetAllComplexDsShapesDrawingInfosAsync(
            List<string>? errorMessages = null)
        {
