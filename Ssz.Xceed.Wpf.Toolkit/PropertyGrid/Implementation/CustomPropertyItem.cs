...
namespace Ssz.Xceed.Wpf.Toolkit.PropertyGrid
{
  ...
  public class CustomPropertyItem : PropertyItemBase
  {
    ...
    public static readonly DependencyProperty IsValueEditorEnabledProperty = DependencyProperty.Register("IsValueEditorEnabled", typeof(bool), typeof(CustomPropertyItem), new PropertyMetadata(true));
    public bool IsValueEditorEnabled
    {
        get
        {
            return (bool)GetValue(IsValueEditorEnabledProperty);
        }
        set
        {
            SetValue(IsValueEditorEnabledProperty, value);
        }
    }
