...
// GetXmlType
OpcXml::Type OpcXml::GetXmlType(VARTYPE varType)
{
    for (int ii = 0; g_pVarTypes[ii].varType != VT_EMPTY; ii++)
    {
...
// GetXmlDateTime
OpcXml::DateTime OpcXml::GetXmlDateTime(const DATE& cDate)
{
...
{ 
    Clear(); m_cValue.vt = VT_DATE; m_cValue.date = GetVarDate((OpcXml::DateTime)cValue); return *this;
}
