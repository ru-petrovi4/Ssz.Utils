        ...
        IUsedAddonsInfo, IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                foreach (DsShapeBase dsShape in SystemDsShapes) 
                    dsShape.Dispose();
        ...
        public static bool IsDsPageFile(string? drawingFileFullName)
        {
            if (drawingFileFullName is null)
                return false;
            return StringHelper.CompareIgnoreCase(Path.GetExtension(drawingFileFullName), DsProject.DsPageFileExtension);
        }

        public static bool IsDsShapeFile(string? drawingFileFullName)
        {
            if (drawingFileFullName is null) 
                return false;
            return StringHelper.CompareIgnoreCase(Path.GetExtension(drawingFileFullName), DsProject.DsShapeFileExtension);
        }
        ...
        {
            FileFullName = drawingInfo.FileFullName;
