...
using Ssz.WindowsAPICodePack.Core.Resources;
using MS.WindowsAPICodePack.Internal;

namespace Ssz.WindowsAPICodePack.ApplicationServices
{
    /// <summary>
    ...
    public static class ApplicationRestartRecoveryManager
    {
        ...
        /// </summary>
        /// <exception cref="Ssz.WindowsAPICodePack.ApplicationServices.ApplicationRecoveryException">
