...
namespace Impl {
	...
	class ATL_NO_VTABLE COPCDaShutdownCallback
		: public ::CComObjectRootEx<::CComMultiThreadModel>
		, public ::CComCoClass<COPCDaShutdownCallback>
		, public ::IOPCShutdown
	{
	public:
		COPCDaShutdownCallback(void);
		virtual ~COPCDaShutdownCallback(void);

		DECLARE_NOT_AGGREGATABLE(COPCDaShutdownCallback)
		DECLARE_GET_CONTROLLING_UNKNOWN()

		DECLARE_PROTECT_FINAL_CONSTRUCT()

		BEGIN_COM_MAP(COPCDaShutdownCallback)
