...
namespace Ssz.Xi.Client.Internal.Context
{
    ...
    internal partial class XiContext
    {
        ...
        /// </param>
        private void OpenEndpoint(string contractType)
        {
            ...
            //try
            //{
            //    epd = _iResourceManagement.OpenEndpoint(ContextId, contractType,
            ...
            //        if (contractType == typeof(IRead).Name)
            //        {
            ...
            //        else if (contractType == typeof(IWrite).Name)
            //        {
            ...
            //        else if (contractType == typeof(IPoll).Name)
            //        {
            ...
            //        else if (contractType == typeof(IRegisterForCallback).Name)
            //        {
            ...
            _openedEndpoinsContractTypes.Add(contractType);
        }
