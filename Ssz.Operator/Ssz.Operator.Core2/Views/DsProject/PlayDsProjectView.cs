...
namespace Ssz.Operator.Core
{
    public static class PlayDsProjectView
    {
        ...
        public static PixelRect? TouchScreenRect { get; set; }
        ...
        public static IPlayWindow? GetPlayWindow(Visual? dependencyObject)
        {
            ...
            if (playWindow is not null) 
                return playWindow;
            var topLevel = TopLevel.GetTopLevel(dependencyObject);
            if (DsProject.Instance.Mode == DsProject.DsProjectModeEnum.DesktopPlayMode)
            {
                WindowBase? window = topLevel as WindowBase;
        ...
        public static void SaveCurrentPlayWindowsConfiguration(bool onlyIfIsNotSavedYet)
        {
            ...
            foreach (IPlayWindow rootWindow in RootPlayWindows.OrderBy(w => w.RootWindowNum))
            {
                ...
                {
                    WindowPosition = rootWindow.Position,                    
                    ContentWidth = rootWindow.PlayControlWrapper.Bounds.Width,
                    ContentHeight = rootWindow.PlayControlWrapper.Bounds.Height
                };
