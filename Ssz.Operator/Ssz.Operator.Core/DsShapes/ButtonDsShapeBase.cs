...
namespace Ssz.Operator.Core.DsShapes
{
    public abstract class ButtonDsShapeBase : ControlDsShape
    {
            ...
            : base(visualDesignMode, loadXamlContent)
        {
            ...
            MouseEnterDsCommand = new DsCommand(visualDesignMode);
            MouseLeaveDsCommand = new DsCommand(visualDesignMode);
        ...
        [Editor(typeof(TextBlockEditor), typeof(TextBlockEditor))]
        [DefaultValue(typeof(DsCommand), @"")] // For XAML serialization
        public DsCommand MouseEnterDsCommand
        {
            get => _mouseEnterDsCommand;
            set => SetValue(ref _mouseEnterDsCommand, value);
        }
        ...
        [Editor(typeof(TextBlockEditor), typeof(TextBlockEditor))]
        [DefaultValue(typeof(DsCommand), @"")] // For XAML serialization
        public DsCommand MouseLeaveDsCommand
        {
            get => _mouseLeaveDsCommand;
            set => SetValue(ref _mouseLeaveDsCommand, value);
        }
        ...
        public override void SerializeOwnedData(SerializationWriter writer, object? context)
        {
            ...
            using (writer.EnterBlock(6))
            {
                ...
                writer.Write(MouseEnterDsCommand, context);
                writer.Write(MouseLeaveDsCommand, context);
                ...
                {   
                    ...
                    case 6:
                        try
                        {
                            ...
                            HoldCommandDelayMs = reader.ReadInt32();
                            HoldCommandIntervalMs = reader.ReadInt32();
                            reader.ReadOwnedData(MouseEnterDsCommand, context);
                            reader.ReadOwnedData(MouseLeaveDsCommand, context);
                            reader.ReadOwnedData(IsDefaultInfo, context);
                            reader.ReadOwnedData(IsCancelInfo, context);
                            reader.ReadOwnedData(RightClickDsCommand, context);
                        }
        ...
        private DsCommand _mouseEnterDsCommand = null!;
        private DsCommand _mouseLeaveDsCommand = null!;
